...
restaurant1 = Restaurant.create(name: "440",
  phone_no: "9898989898",
  email: "440@gmail.com",
...
restaurant2 = Restaurant.create(name: "440",
  phone_no: "9898989898",
  email: "440@gmail.com",
  opening_time: Time.now,
  closing_time: Time.now,
...
restaurant3 = Restaurant.create(name: "US Pizza",
  phone_no: "9090909090",
...
restaurant4 = Restaurant.create(name: "McDonald's",
  phone_no: "8778878787",
...
restaurant5 = Restaurant.create(name: "The Chocolate Room",
  phone_no: "9876543210",
...
FoodItem.create(name: "Vadapav",
  price: 30,
  category_id: category1.id,
  restaurant_id: restaurant1.id,
  food_type: 0)

FoodItem.create(name: "French Fries",
  price: 70,
  category_id: category1.id,
  restaurant_id: restaurant1.id,
  food_type: 0)

FoodItem.create(name: "Chocolate Pastry",
  price: 60,
  category_id: category1.id,
  restaurant_id: restaurant5.id,
  food_type: 0)

FoodItem.create(name: "Black Forest Pastry",
  price: 65,
  category_id: category1.id,
  restaurant_id: restaurant5.id,
  food_type: 0)

FoodItem.create(name: "Pizza",
  price: 110,
  category_id: category1.id,
